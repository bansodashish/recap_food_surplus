  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div 
              ...
              onClick={() => limits.canUploadCSV && setUploadMethod('csv-photos')}
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center">
                  ...
                  <h3 className={`font-medium ${!limits.canUploadCSV ? 'text-gray-400' : ''}`}>CSV + Photos</h3>
                </div>
                <span className="ml-2 text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">S3 Storage</span>
                {!limits.canUploadCSV && (
        ...
        {uploadMethod === 'csv-photos' && limits.canUploadCSV && (
          <div className="mb-8">
